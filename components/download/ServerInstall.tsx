...
export default function ServerInstall({ locale }: { locale: any }) {
  ...
  return (
    <div className="w-full max-w-7xl pt-14">
      <div className="bg-[#EBF6FF] dark:bg-[#04071B] border border-[#19F3FF22] rounded-2xl shadow-lg p-8 mx-auto">
      ...
      <div className="w-full pt-5 grid grid-cols-1 md:grid-cols-3 gap-5 mx-auto">
        {/* macOS */}
        <div className="bg-[#EBF6FF] dark:bg-[#04071B] border border-[#19F3FF22] rounded-2xl px-8 py-10 flex flex-col shadow-lg min-h-[200px]">
