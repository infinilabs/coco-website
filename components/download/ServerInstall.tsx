...
export default function ServerInstall({ locale }: { locale: any }) {
  ...
  return (
    <div className="w-full max-w-7xl pt-14">
      <div className="bg-[#EBF6FF] dark:bg-[#04071B] border border-[#49FFF3] rounded-2xl shadow-lg p-8 mx-auto">
        ...
        <div className="flex items-center bg-white dark:bg-[#0A1727] rounded-lg px-4 py-3 mb-2">
      ...
      <div className="w-full pt-5 grid grid-cols-1 md:grid-cols-3 gap-5 mx-auto">
        {/* macOS */}
        <div className="bg-[#EBF6FF] dark:bg-[#04071B] border border-[#49FFF3] rounded-2xl px-8 py-10 flex flex-col shadow-lg min-h-[200px]">
          ...
          <div className="flex flex-col gap-3 mt-4">
            {macLinksServer.map((item) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-between bg-white dark:bg-[#0A1727] rounded-lg px-4 py-3 text-black dark:text-white transition hover:bg-[#232A3F]"
              >
