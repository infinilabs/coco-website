        ...
        <div className="space-y-8 text-gray-300">
          ...
          <section className="space-y-4">
            ...
            <div className="text-sm space-y-4">
              <p>
                Coco is committed to protecting your privacy. We have prepared
                this Privacy Policy to describe to you our practices regarding
                the Personal Data (as defined below) we collect from users of
                our website located at coco.rs and in connection with our other
                INFINI Labs products and services (the &ldquo;Products&rdquo;).
              </p>
              <p>
